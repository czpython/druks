...
Saving status fields and doctor check the configured names against the connected tracker.
Save a tracker selection first, then choose and save its status names.
