...
For the bundled `software_factory` app, connect the GitHub App druks acts as from
...
workflow and its trigger. In the bundled distribution, `software_factory` is the reference
