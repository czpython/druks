...
their own phone. Druks also writes to you. Its messages start with "Druks:", and
...
from the Druks message. When more than one decision is open, ask which one they mean.
