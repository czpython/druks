...
function codexItemRows(item: unknown): Row[] {
  ...
  if (itemType === 'agent_message') {
    ...
    // noise; legacy transcripts still carry them). It is the call's saved
    // output, shown in its own view, so it drops. Prose renders as text —
    // today's codex can't emit it, but it's the upgrade path if the CLI
    // ever enforces final-only.
