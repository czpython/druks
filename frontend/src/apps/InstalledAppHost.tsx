...
export interface ShellContext {
  ...
  // The accent the shell assigned this app. Everything else about the
...
// Mounts an installed app's shipped ESM bundle below the chrome: loads
...
export function InstalledAppHost({ name }: { name: string }) {
  ...
  useEffect(() => {
    ...
    const ctx: ShellContext = {
      ...
      theme: { accent: appAccent(names)[name] ?? '' },
